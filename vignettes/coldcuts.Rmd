...
In this example, we use the a NiFTi (`ABA_Human_half.nii.gz`) file from the Allen Institute for Brain Sciences which we can find [here](https://github.com/langleylab/coldcuts_segmentations/tree/main/ABA_Human_half) together with its ontology, containing a 500&mu;-spaced voxel array with 141 annotated structures. We add the ontology file `ABA_Human_half.ontology.csv` as well, both of which can be found in the `data` folder of this repository.
...
seg <- seg_draw(nifti_file = "ABA_Human_half.nii.gz", 
                        ontology_file = "ABA_Human_half.ontology.csv",
...
<img width="1010" alt="ontology_graph" src="https://raw.githubusercontent.com/langleylab/coldcuts_segmentations/main/HCP_MMP/HCPMMP1_Human_ontology.png">
